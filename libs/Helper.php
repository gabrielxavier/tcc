...
class Helper {
	...
	public function getSituacaoDecorations($id, $key){
		$decorations = array(
            1 => array('icon'=> 'glyphicon-asterisk', 'color'=>'info'),
            2 => array('icon'=> 'glyphicon-time', 'color'=>'warning'),
	...
	public function displayFlashMessage()
	{
		...
		if( isset($_SESSION['flash_messages']['error']) )
		{
			...
			echo implode('<br />', array_unique($_SESSION['flash_messages']['error']) );
			echo '</p></div>';
		}
		...
		if( isset($_SESSION['flash_messages']['success']) )
		{
			...
			echo implode('<br />', array_unique($_SESSION['flash_messages']['success']) );
			echo '</p></div>';
		}
		...
		if( isset($_SESSION['flash_messages']['warning']) )
		{
			...
			echo implode('<br />', array_unique($_SESSION['flash_messages']['warning']) );
			echo '</p></div>';
		}
